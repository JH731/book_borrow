...
public interface BackMapper {
    ...
    @Select("SELECT bc.id,bw.start_time as startTime,bw.end_time as endTime,bw.return_time as returnTime, bw.status,bk.name as bookName, bk.author as author, bk.publish as publish, bk.edition as edition, ct.name AS categoryName, bu.name as userName " +
